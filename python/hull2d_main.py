...
#reakpoint()
nedges,edges,iverts = qhull2d(x,y)

Fout = open(fout,'w')

Fout.write(str(len(iverts)) + '  !number of points\n')
Fout.write(str(nedges) + '  !number of edges\n')
